  ...
  oneBtnClick () {
    ...
    if (GameApp.dataManager.reduceCoin(GameApp.dataManager.userData.box1NeedCoinNum)) {
      GameApp.uiManager.showPopup('OpenBoxPopup', (node) => {
        const getNum = Tools.randomNum(GameApp.dataManager.userData.box1RewardCoinNum[0], GameApp.dataManager.userData.box1RewardCoinNum[1])
  ...
  twoBtnClick () {
    ...
    if (window.tt) {
      Utils.addVideo('addVideo', function () { // 看完了
        ...
        GameApp.uiManager.showPopup('OpenBoxPopup', (node) => {
          const getNum = Tools.randomNum(GameApp.dataManager.userData.box2RewardCoinNum[0], GameApp.dataManager.userData.box2RewardCoinNum[1])
          GameApp.dataManager.addCoin(getNum)
  ...
  threeBtnClick () {
    ...
    if (window.tt) {
      Utils.addVideo('addVideo', function () { // 看完了
        self.onceClick = true
        GameApp.dataManager.addPlayedVideoNum()
        const getIndex = Tools.randomNum(26, 30)
        const getNum = 5
