...
cc.Class({
  ...
  onLoad () {
    ...
    let passDays = cc.sys.localStorage.getItem('EatChicken_passDays')
    ...
    let dailyDate = cc.sys.localStorage.getItem('EatChicken_dailyDate')
    if (dailyDate == null || dailyDate == undefined || dailyDate == '') {
      ...
      if (date >= dailyDate) {
        const newDate = date - dailyDate
        const newtime = Tools.toTimeString2(newDate)
